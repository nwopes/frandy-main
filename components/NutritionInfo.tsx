            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {nutrients.map((item, index) => (
                        <div key={index} className="bg-[#1F1D2B] rounded-2xl p-8 border border-white/5 hover:border-gummy-red/30 transition-all duration-300 hover:-translate-y-1 shadow-lg">
