    ...
    return (
        <>
            <nav className="sticky top-0 z-50 bg-[var(--background)]/80 backdrop-blur-md border-b border-white/5">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex space-x-8">
                            ...
                            <Link href="/#about" className="text-gray-300 hover:text-gummy-red font-medium transition-colors">
                                About
                            </Link>
                            <button
                                onClick={() => setIsContactOpen(true)}
                                className="text-gray-300 hover:text-gummy-red font-medium transition-colors"
                            >
                                Contact
                            </button>
                        </div>
                ...
                {/* Mobile Menu */}
                {isMobileMenuOpen && (
                    <div className="md:hidden bg-[#1F1D2B] border-b border-white/5">
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                            <Link href="/" className="text-gray-300 hover:text-gummy-red hover:bg-white/5 block px-3 py-2 rounded-md text-base font-medium transition-colors" onClick={() => setIsMobileMenuOpen(false)}>
                                Shop
                            </Link>
                            <Link href="/#about" className="text-gray-300 hover:text-gummy-red hover:bg-white/5 block px-3 py-2 rounded-md text-base font-medium transition-colors" onClick={() => setIsMobileMenuOpen(false)}>
                                About
                            </Link>
                            <button
                                className="w-full text-left text-gray-300 hover:text-gummy-red hover:bg-white/5 block px-3 py-2 rounded-md text-base font-medium transition-colors"
                                onClick={() => {
